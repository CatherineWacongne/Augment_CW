classdef CT_MultHiddenNetworkMemo < handle
    ...
    properties
        ...
        weights_dxym; % Weights from deriv input to hidden memory units
        weights_ymx; % Weights from memory hidden to input
        ...
        wdxym_traces;  % Eligibility traces input synapses
        wymx_traces;
        ...
        dX; % Current input derivatives 
        Y; % Current hidden layer activations
        Ym; % Current memory hidden layer activations
        prev_x;
        prev_dx;
        prev_y;
        prev_ym;
