function [outfile,deepstructure,surface] = StimulusGeneration(nsentences,varargin)
...
maxlength = 10; %%% max number of true terminal words in the surface structure
minlength = 3; %%% min number of true terminal words
