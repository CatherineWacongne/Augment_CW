...
if obj.prev_action<=obj.nzs
    ...
    activation_modul = obj.weights_zzs(obj.prev_action-obj.nzs+1,obj.prev_action-obj.nzs).* obj.weights_yzs(1+obj.bias_hidden:obj.ny_normal+obj.bias_hidden,obj.prev_action-obj.nzs)'+obj.weights_yz(1+obj.bias_hidden:obj.ny_normal+obj.bias_hidden,obj.prev_action-obj.nzs)' ;
